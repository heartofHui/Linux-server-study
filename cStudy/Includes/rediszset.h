...
public:
	 ...
	 * return:
	 * 		true:find member false:not find member*/
	bool zScore(const int64_t& mem,int64_t& score);
	 ...
	 * */
	void zRange(const int64_t& startRank,const int64_t& endRank,std::vector<NodeValue>& resList,const bool& withscores=false,const int64_t& limitCount=-1);

	/*function:get reverse range vector by startRank and endRank
	 * */
	void zRevRange(const int64_t& startRank,const int64_t& endRank,std::vector<NodeValue>& resList,const bool& withscores=false,const int64_t& limitCount=-1);

	/*function:get range vectos by startScore and endScore*/
	void zRangeByScore(const int64_t& startScore, const int64_t& endScore, std::vector<NodeValue>& resList,const bool& withscores=false, const int64_t& limitCount=-1);
...
void ClZset::zRange(const int64_t& startRank,const int64_t& endRank,std::vector<NodeValue>& resList,const bool& withScores, const int64_t& limitCount)
{
	skpl.getRangeByRank(startRank,endRank,resList,withScores,limitCount,false);
}

void ClZset::zRevRange(const int64_t& startRank,const int64_t& endRank,std::vector<NodeValue>& resList,const bool& withScores, const int64_t& limitCount)
{
...
bool ClZset::zScore(const int64_t& mem,int64_t& score)
{
	score = 0;
...
void ClZset::zRangeByScore(const int64_t& start, const int64_t& end, std::vector<NodeValue>& resList, const bool& withscores, const int64_t& limitCount)
{
	skpl.getRangeByScore(start,end,resList,withscores,limitCount);
}
